//
//  LMFeedQnACreatePostViewModel.swift
//  LikeMindsFeedCore
//
...
public protocol LMFeedQnACreatePostViewModelProtocol: LMBaseViewControllerProtocol {
...
public final class LMFeedQnACreatePostViewModel {
    ...
    // MARK: Data Variables
    public weak var delegate: LMFeedQnACreatePostViewModelProtocol?
    ...
    init(delegate: LMFeedQnACreatePostViewModelProtocol?) {
    ...
    public static func createModule() throws -> LMFeedQnACreatePostScreen {
        guard LMFeedCore.isInitialized else { throw LMFeedError.feedNotInitialized }
        let viewcontroller = LMFeedQnACreatePostScreen()
        let viewModel = LMFeedQnACreatePostViewModel(delegate: viewcontroller)
        
        viewcontroller.viewModel = viewModel
        return viewcontroller
    }
    
    func createPost(question: String, text: String) {
...
// MARK: Assets Arena
public extension LMFeedQnACreatePostViewModel {
...
// MARK: Link Detection
extension LMFeedQnACreatePostViewModel {
