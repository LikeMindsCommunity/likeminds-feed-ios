...
open class LMFeedPostDetailViewController: LMViewController {
    ...
    open override func setupLayouts() {
        ...
        tagsTableViewHeightConstraint = NSLayoutConstraint(item: taggingView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1, constant: 0)
